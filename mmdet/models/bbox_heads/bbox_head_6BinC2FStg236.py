...
#                GtCountsDiv_list[idx] = 32
            if count ==0:
                ...
                GtCountsDiv_list[idx] = 5
            elif 6 <=count <=7:
                GtCountsDiv_list[idx] = 6
            elif count ==8:
                GtCountsDiv_list[idx] = 8
            elif count ==9:
                GtCountsDiv_list[idx] = 9           
            elif 10 <= count <= 11:
    ...
    def Stage2Div(self, Counts):
        ...
        for idx, count in enumerate(Counts_np):
            if count ==0:
                ...
                GtCountsDiv_list[idx] = 11
            elif count == 12:
                GtCountsDiv_list[idx] = 12
            elif count == 13:
                GtCountsDiv_list[idx] = 13
            elif 14 <= count <= 15:
                GtCountsDiv_list[idx] = 14
            elif count == 16:
                GtCountsDiv_list[idx] = 16                
            elif count == 17:
                GtCountsDiv_list[idx] = 17
                ...
                GtCountsDiv_list[idx] = 19
            elif count == 20:
                GtCountsDiv_list[idx] = 20                
            elif count == 21:
                GtCountsDiv_list[idx] = 21
            elif 22 <=count <=23:
                GtCountsDiv_list[idx] = 22
            elif count == 24:
                GtCountsDiv_list[idx] = 24                
            elif count == 25:
                GtCountsDiv_list[idx] = 25
            elif 26 <= count <=27:
                GtCountsDiv_list[idx] = 26
            elif 28 <= count <=31:
                GtCountsDiv_list[idx] = 28
            elif count == 32:
                GtCountsDiv_list[idx] = 32
            elif count == 33:
                GtCountsDiv_list[idx] = 33
                ...
                GtCountsDiv_list[idx] = 35
            elif count == 36:
                GtCountsDiv_list[idx] = 36
            elif count == 37:
                GtCountsDiv_list[idx] = 37
            elif 38 <= count <= 39:
                GtCountsDiv_list[idx] = 38
            elif count == 40:
                GtCountsDiv_list[idx] = 40
            elif count == 41:
                GtCountsDiv_list[idx] = 41
            elif 42 <= count <= 43:
                GtCountsDiv_list[idx] = 42
            elif 44<=count<= 48:
                GtCountsDiv_list[idx] = 44
            elif count == 49:
                GtCountsDiv_list[idx] = 49
            elif 50 <=count <= 51:
                GtCountsDiv_list[idx] = 50
            elif 52 <=count <= 55:
                GtCountsDiv_list[idx] = 52
            else:
                GtCountsDiv_list[idx] = 56
    ...
    def N3bin2int(self, bin_list):
        if len(bin_list) != 3:
            return 1
        for idx, e in enumerate(bin_list):
            if e < 0.5:
                bin_list[idx]=int(0)
            else:
                bin_list[idx]=int(1)
        #print(bin_list[0],bin_list[1],bin_list[2])
        if bin_list[0]==0 and bin_list[1] == 0 and bin_list[2]==1:
            return 1
        elif bin_list[0]==0 and bin_list[1] == 1 and bin_list[2]==0:
            return 3
        elif bin_list[0]==0 and bin_list[1] == 1 and bin_list[2]==1:
            return 7
        elif bin_list[0]==1 and bin_list[1] == 0 and bin_list[2]==0:
            return 13
        elif bin_list[0]==1 and bin_list[1] == 0 and bin_list[2]==1:
            return 17
        elif bin_list[0]==1 and bin_list[1] == 1 and bin_list[2]==0:
            return 25
        elif bin_list[0]==1 and bin_list[1] == 1 and bin_list[2]==1:
            return 50
    ...
    def loss(self, Stage_i,    # Fixme: + Resized Coarse-to-fine division and loss. Add the stage Flag.
        ...
        if Stage_i == 0:
            ...
            Loss_count_weight = 2.0
        else:
            Loss_count_weight = 3.0
        ...
        if count_score is not None:
            ...
            losses['loss_count'] = Loss_count_weight*self.loss_count(     # Fixme: + Resized binary count  0.0001==>0.001==>0.01
               count_score,
               counts,
               count_weights,
               avg_factor=avg_factor#,
