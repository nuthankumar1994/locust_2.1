...
class BBoxHead(nn.Module):
    ...
    def __init__(self,
                 ...
                 loss_count=dict( 
                     type='SmoothL1Loss', beta=1.0, loss_weight=1.0, pick=-1)):   #Fixme:'MSELoss', loss_weight=1.0   
        ...
        if self.with_count:  
            self.fc_count = nn.Linear(in_channels, 8)  #Fixme: +  Resized binary count 1==>8
    ...
    def loss(self,
        ...
        if count_score is not None:
            ...
            losses['loss_count'] = 0.01*0.125*self.loss_count(     # Fixme: + Resized binary count  0.0001 ==> 0.01 ==>0.001|
               count_score,
               counts,
               count_weights,
               avg_factor=avg_factor,
    ...
    def get_det_bboxes(self,
        ...
        #Fixme: + Resized count binary: transform the 7 bit binary to the float32 type.        
