    ...
    def _parse_ann_info(self, img_info, ann_info):
        ...
        for i, ann in enumerate(ann_info):
            ...
            if ann.get('iscrowd', False):
                ...
                #gt_counts.append(self.int2bin(ann['count']))   #Fixme: +  Resized binary count 1==>7
        ...
        if gt_bboxes:
            ...
            gt_counts = np.array([], dtype=np.int64)              #Fixme: + count
            # gt_counts = np.array([0,0,0,0,0,0,1], dtype=np.int64)    #Fixme: +  Resized binary count [] ==> [0,0,0,0,0,0,1] float32
