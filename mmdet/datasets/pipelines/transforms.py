    ...
    def __call__(self, results):
        ...
        if 'gt_bboxes' in results:
            ...
            if 'gt_labels' in results:
                ...
                results['gt_counts'] = results['gt_counts'][valid_inds]     #Fixme: +
...
class MinIoURandomCrop(object):
    ...
    def __call__(self, results):
        img, boxes, labels, counts = [
            results[k] for k in ('img', 'gt_bboxes', 'gt_labels', 'gt_counts')      #Fixme:+
        ]
        h, w, c = img.shape
        while True:
